 ...
 *
 * @generatedBy CodePro at 4/9/16 11:43 PM
 * @author Ken
...
public class VendingMachineTest {
	 ...
	 * @throws Exception
	 *
	 * @author K. Capolongo at 4/10/16 12:49 AM
	 */
	@Test(expected = edu.towson.cis.cosc603.project4.vendingmachine.VendingMachineException.class)
...
//		fixture.balance = 1.0;
	 ...
	 * @throws Exception
	 *
	 * @author K. Capolongo at 4/10/16 12:44 AM
	 */
	@Test
	public void testMakePurchase_5()
		...
		fixture.balance = 1.0;
		String code = "D";
		fixture.addItem(new VendingMachineItem("", 1.00), code);
		boolean result = fixture.makePurchase(code);
